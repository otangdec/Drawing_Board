 ...
 * Program Name: ControlPanel.java
 * Objective: To create a Panel containing the tools for drawing;
 * Features:
 * 	- Color Radio Buttons: to change the pen color to either Red or Yellow or Blue
 *  - Clear Button: To clear the Drawing Panel
 *  - Undo Button: To reverse to the previous action (if any)
 *  - Redo Button: To forward to the next action (if any)
 */
