 ...
 * Program Name: ExtraFeaturePanel.java
 * Objective: To create a Panel containing the more tools for drawing;
 * Features:
 * 	- Export Buttons: to save the content inside the drawing panel to the selected destination
 *  - round Radio Button: to change the pen shape to round shape
 *  - square Radio Button: to change the pen shape to square shape
 *  - erase Radio Button: to activate the eraser to erase content on the drawing panel
 *  - The size slider: To change the size of the pen
 *  - Drop down Size Box: To change the size of the pen to the pre-defined size
 */ 
...
public class ExtraFeaturePanel extends JPanel {
	...
	//Method to create PenSizeComboBox
	...
	//Method to create Choose Color Button
	...
	//Method to create a Slider to set the size of the pen
	...
	private class ButtonListener implements ActionListener{
		...
		//Method to set pen size Dimension
